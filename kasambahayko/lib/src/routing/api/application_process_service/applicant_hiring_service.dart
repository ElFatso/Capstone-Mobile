...
class HiredApplicantService {
  final Dio dio = Dio();

  Future<Map<String, dynamic>> getHiredApplicant(String jobpostId) async {
    final uri = Uri.parse(
        '${ApiConstants.baseUrl}/employer/post/$jobpostId/hired-applicant');
