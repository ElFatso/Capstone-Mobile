...
class StartApplicationService {
  final Dio dio = Dio();

  Future<Map<String, dynamic>> startJobApplication(String jobpostId) async {
    final uri = Uri.parse(
        '${ApiConstants.baseUrl}/employer/post/$jobpostId/application/start');
