...
class DeletePassedService {
  final Dio dio = Dio();

  Future<Map<String, dynamic>> deletePassedResult(
      String jobpostId, String applicationId) async {
    final uri = Uri.parse(
        '${ApiConstants.baseUrl}/employer/post/$jobpostId/interview/$applicationId/passed');
    ...
    try {
      ...
      if (response.statusCode == 200) {
        return {'success': true, 'message': 'Interview pass removed'};
      } else {
