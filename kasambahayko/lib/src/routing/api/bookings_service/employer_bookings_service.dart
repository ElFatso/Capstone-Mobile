...
class EmployerBookingsService {
  final Dio dio = Dio();

  Future<Map<String, dynamic>> getAllBookings(String employerId) async {
    final Uri bookingsUri = Uri.parse(
        '${ApiConstants.baseUrl}/employer/$employerId/all-bookings/simple');
