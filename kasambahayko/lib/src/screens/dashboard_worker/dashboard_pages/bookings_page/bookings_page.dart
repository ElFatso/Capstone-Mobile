...
import 'package:kasambahayko/src/screens/dashboard_worker/dashboard_pages/bookings_page/booking_details.dart';
import 'package:kasambahayko/src/screens/dashboard_worker/dashboard_pages/bookings_page/booking_request.dart';
...
class BookingsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Scaffold(
        body: GetBuilder<WorkerBookingsController>(
          init: WorkerBookingsController(),
          builder: (controller) {
            return Column(
              children: [
                Container(
                ...
                if (controller.isLoading.value)
                  ...
                  Expanded(
                    child: ListView.builder(
                      itemCount: controller.workerBookings.length,
                      itemBuilder: (context, index) {
                        final booking = controller.workerBookings[index];
                        final jobTitle = booking['title'];
                        final employer = booking['employer'];
                            ...
                            child: Column(
                              children: [
                                ...
                                ElevatedButton(
                                  ...
                                  onPressed: () async {
                                    if (type == 'booking') {
                                      final workerBookingDetailsController =
                                          Get.find<
                                              WorkerBookingDetailsController>();
